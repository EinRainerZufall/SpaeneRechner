...
void createDatabase::createSimple() {
...
void createDatabase::createDynamic() {
    const std::string file = (QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation)).toStdString() + name;
    int column = 1;
    int row = 2;
    int color = 191;
...
void createDatabase::createDrill() {
    const std::string file = (QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation)).toStdString() + name;
    int column = 1;
    int row = 2;
    int color = 191;
...
void createDatabase::createSlot() {
    const std::string file = (QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation)).toStdString() + name;
    int column = 2;
    int row = 1;
    int color = 191;
...
void createDatabase::createPlan90() {
    const std::string file = (QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation)).toStdString() + name;
    int column = 1;
    int row = 2;
    int color = 191;
...
void createDatabase::createPlan45() {
    const std::string file = (QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation)).toStdString() + name;
    int column = 1;
    int row = 2;
    int color = 191;
...
void createDatabase::createTurn() {
    const std::string file = (QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation)).toStdString() + name;
    int column = 1;
    int row = 2;
    int color = 191;
...
void createDatabase::createThread() {
    const std::string file = (QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation)).toStdString() + name;
    int column = 2;
    int row = 1;
    int color = 191;
...
void createDatabase::deleteWorkbook(){
    const std::string file = (QStandardPaths::writableLocation(QStandardPaths::AppLocalDataLocation)).toStdString() + name;
